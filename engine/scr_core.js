...
cs.sprite = {
    ...
    info: function(sprName){
         return {
              width: cs.sprite.list[sprName].fwidth,
              height: cs.sprite.list[sprName].fheight,
              xoff: cs.sprite.list[sprName].xoff,
              yoff: cs.sprite.list[sprName].yoff,
              frames: cs.sprite.list[sprName].frames
         }
    }
}
//---------------------------------------------------------------------------------------------//
